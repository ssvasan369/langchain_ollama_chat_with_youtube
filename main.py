...
llm = ChatOllama(base_url="http://127.0.0.1:11434", model="mistral:latest")
    ...
    with st.spinner("Processing YouTube video..."):
        ...
        if docs:
            ...
            try:
                ...
                print(e)  # Print the entire error object
                print(dir(e))  # List all attributes and methods of the object
